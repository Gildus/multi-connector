...
use Dgild\MultiConnector\Manager;
...
class AuthManager extends Manager
{
    ...
    /**
     * Create an instance of the Ldap driver.
     *
     * @return \Illuminate\Auth\Guard
     */
    ...
    /**
     * Create an instance of the Ldap user provider.
     *
    ...
    protected function createLdapProvider()
    {
        ...
        $provider = new \Dgild\MultiConnector\MultiUserProvider($ldap);
